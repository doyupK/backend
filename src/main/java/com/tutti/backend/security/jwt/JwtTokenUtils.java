...
public final class JwtTokenUtils {
    ...
    public static final String CLAIM_ARTIST = "ARIST";
    ...
    public static String generateJwtToken(UserDetailsImpl userDetails) {
        ...
        try {
            token = JWT.create()
                    ...
                    .withClaim(CLAIM_ARTIST,userDetails.getUser().getArtist())
                    .withClaim(CLAIM_PROFILE_IMG,userDetails.getUser().getProfileUrl())
